...
The Hawaii project is a meritocratic, consensus-based community interested in developing a Linux-based operating system.

Anyone who shares that interest can join the community, participate in its decision making processes, and contribute to its development.
...
The model will probably change as the Project and its community develop.
...
The Maui Project asks its Users to participate in the community as actively as possible.
...
Approvers are community members who have shown that they are committed to the Project and its objectives, and perform an essential role safeguarding its long-term success.

Approvers review all code contributions and decide which are accepted for commitment based on “technical fit” and “spirit fit” with the Project. Approvers are also Contributors and in exceptional cases (like fixing a compile error) they can directly commit their own code, but this is unusual.
...
He / she sets the overall vision and direction of the Maui Project.
...
Any community member can make a proposal for consideration by the community. In order to initiate a discussion about a new idea, they should send an email to the development mailing list or submit a patch implementing the idea to the review tool, which is the preferred option. This will prompt a review and, if necessary, a discussion of the idea.
...
The new process is documented in the Maui Contribution Guidelines

Based on the Qt Governance Model which in turn is based on the Meritocratic Governance Model OSS-Watch template.
